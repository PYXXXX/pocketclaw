...
final class GatewayFrameCodec {
  GatewayFrameCodec({GatewayParser? parser}) : _parser = parser ?? const GatewayParser();
  ...
  GatewayMessage decodeFrame(String rawFrame) {
    ...
    if (decoded is! Map<String, Object?>) {
      throw const GatewayProtocolException('Gateway frame must decode to a JSON object.');
    }
