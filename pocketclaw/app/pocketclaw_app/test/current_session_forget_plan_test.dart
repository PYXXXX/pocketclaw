...
void main() {
  ...
  test('CurrentSessionForgetPlan returns null when only one session exists', () {
  ...
  test('CurrentSessionForgetPlan picks the next session when removing first', () {
  ...
  test('CurrentSessionForgetPlan picks previous session when removing middle or last', () {
    final sessions = <LocalSessionEntry>[
      session('pc-home'),
      session('pc-2'),
      session('pc-3'),
