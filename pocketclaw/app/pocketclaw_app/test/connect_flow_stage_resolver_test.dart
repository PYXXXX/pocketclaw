...
void main() {
  test('resolveConnectFlowStageForError maps pairing required to pairingPending', () {
  ...
  test('resolveConnectFlowStageForError maps auth failures to authRequired', () {
    final stage = resolveConnectFlowStageForError(
      const GatewayRequestError(
        code: 'UNAVAILABLE',
        message: 'auth blocked',
        details: <String, Object?>{'code': GatewayErrorCodes.authTokenMismatch},
      ),
    );
